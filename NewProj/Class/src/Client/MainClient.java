...
import Logic.*;	//Change this import to your package name
public class MainClient {
    ...
    public EllipseShape mEllipseShape;
	 ...
	 */
	public MainClient() {
		mEllipseShape=new EllipseShape();
		initialize();
	...
	private void initialize() {
		...
		final SpriteField mSpritepanel = mEllipseShape.sp;
		mEllipseShape.sp.addMouseListener(new MouseAdapter() {
			@Override
			...
			mEllipseShape.sp.CreateSpriteAt(tX,tY,h,w,hex,ang); //We are passing height and width fetched from textfield to SpriteClass
			temptX = tX;
			temptY = tY;
			temph = h;
			tempw = w;
		...
		mEllipseShape.sp.setBackground(Color.GRAY);
		mEllipseShape.sp.setBounds(91, 13, 329, 227);
		...
		btnNewButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent ae) {				
				...
				mEllipseShape.sp.CreateSpriteAt(temptX,temptY,temph,tempw,"#7E7E7E",tempang); //We are passing height and width fetched from textfield to SpriteClass
			}
		...
		btnNewButton_1.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent ae) {				
				...
				mEllipseShape.sp.CreateSpriteAt(temptX,temptY,temph,tempw,"#7E7E7E",tempang); //We are passing height and width fetched from textfield to SpriteClass
				mEllipseShape.sp.CreateSpriteAt(temptX,temptY,temph,tempw,temphex,tempang+15); 
				tempang = tempang + 15;
			}
