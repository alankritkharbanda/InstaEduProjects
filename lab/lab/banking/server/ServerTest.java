...
class ServerTest {
	public static void main(String args[]) {
		...
		AccountServerFactory factory = AccountServerFactory.getMe();
		AccountServer server = factory.lookup();
		
		List<Iaccount> initialTest = server.getAllAccounts();
		...
		Iaccount acc = server.getAccount("Bob");
