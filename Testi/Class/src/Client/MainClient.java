...
public class MainClient {
	...
	private void initialize() {
		...
		mSpritepanel.addMouseListener(new MouseAdapter() {
			...
			mSpritepanel.CreateSpriteAt(tX,tY,h,w,hex,ang); //We are passing height and width fetched from textfield to SpriteClass
			temptX = tX;
			temptY = tY;
			temph = h;
			tempw = w;
		...
		mSpritepanel.setBackground(Color.GRAY);
		mSpritepanel.setBounds(91, 13, 329, 227);
		...
		btnNewButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent ae) {				
				...
				mSpritepanel.CreateSpriteAt(temptX,temptY,temph,tempw,"#7E7E7E",tempang); //We are passing height and width fetched from textfield to SpriteClass
			}
		...
		btnNewButton_1.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent ae) {				
				...
				mSpritepanel.CreateSpriteAt(temptX,temptY,temph,tempw,"#7E7E7E",tempang); //We are passing height and width fetched from textfield to SpriteClass
				mSpritepanel.CreateSpriteAt(temptX,temptY,temph,tempw,temphex,tempang+15); 
				tempang = tempang + 15;
			}
