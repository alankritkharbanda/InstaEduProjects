...
//main window class for gui of game , controls the complete window //of game, with boundaries and cells
...
public class MainWindow extends JFrame implements MonopolyGUI{
	...
	//constructor 
	public MainWindow() {
		//set black border to all 4 panels
